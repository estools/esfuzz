...
void function () {
  var cache$, escodegen, generate, Program, randomBool, randomElement, randomFormat, randomInt, render, renderForComparison, RoundtripFailureError;
  ...
  exports.generate = generate = function (options) {
    if (null == options)
      options = {};
    return Program(null != options.maxDepth ? options.maxDepth : 8);
  };
  ...
  renderForComparison = function (programAST) {
    return render(programAST, escodegen.FORMAT_MINIFY);
  };
