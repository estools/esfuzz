...
void function () {
  var $0, cache$, counter, fuzz, knownOpts, nonstandardFuzz, nonstandardParsers, nopt, optAliases, options, parsers, path, recur;
  path = require('path');
  nopt = require('nopt');
  cache$ = require('./index');
  fuzz = cache$.fuzz;
  nonstandardFuzz = cache$.nonstandardFuzz;
  knownOpts = {
    acorn: Boolean,
    es6: Boolean,
    esprima: Boolean,
  ...
  counter = 0;
  (recur = function () {
    var ast, cache$1, err, js, message, name, stack;
