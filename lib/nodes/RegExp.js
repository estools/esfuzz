...
void function () {
  var Alternation, Boundary, cache$, cache$1, Character, CharacterClass, CharacterClassCharacter, CharacterClassRange, charVal, genSafeRegExp, Grouping, Hex, listOf, listOfExactly, oneOf, printableAscii, randomElement, randomInt, RegExp_, RegExpSource, Repetition, Sequence;
  ...
  RegExp_ = function () {
    ...
    function RegExp_(depth) {
      this.value = genSafeRegExp();
    }
    return RegExp_;
  }();
  module.exports = function () {
    return construct$(RegExp_, [].slice.call(arguments).concat());
  };
