...
void function () {
  var cache$, construct, eq, Expression, FunctionExpression, Getter, Identifier, IdentifierName, Key, listOf, nubBy, Number_, ObjectExpression, oneOf, Property, propName, Setter, String_;
  ...
  ObjectExpression = function () {
    ...
    function ObjectExpression(depth) {
      --depth;
      if (depth > 0)
